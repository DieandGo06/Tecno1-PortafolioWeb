...
//Mensaje 6B
  ...
  if(time3>=12 && seleccion3==2020){
    fade2= constrain(fade2, 0, 1000);
    fill(0,fade2); rect (0,0, width, height);
    textAlign (CENTER);
    fill(255,(fade2-350)); text("Final [C]", (width/2), height/2-15-cUp);
    fill(255,(fade2-600)); text("[C]alla", (width/2), height/2+15-cUp);
    fade2+= 3;
  }
  //Final P (seleccion= 2001)
  if(time3>=52 && seleccion3==2001){
    ...
    fill(0,fade2); rect (0,0, width, height);
    textAlign (CENTER);
    fill(255,(fade2-350)); text("Final [P]", (width/2), height/2-15-cUp);
    fill(255,(fade2-550)); text("[P]or última vez", (width/2), height/2+15-cUp);
    fade2+= 3;
  }
  //Final S (seleccion= 1046)
  if(time4>=48 && seleccion4==1046){
    ...
    fill(0,fade2); rect (0,0, width, height);
    textAlign (CENTER);
    fill(255,(fade2-350)); text("Final [S]", (width/2), height/2-15-cUp);
    fill(255,(fade2-600)); text("Silencio", (width/2), height/2+15-cUp);
    fade2+= 3;
  }
  ...
  if(time4>=88 && seleccion4==1028){
    ...
    fill(0,fade2); rect (0,0, width, height);
    textAlign (CENTER);
    fill(255,(fade2-350)); text("Final [N]", (width/2), height/2-15-cUp);
    fill(255,(fade2-600)); text("Isla de sueaños [R]otos", (width/2), height/2+15-cUp);
    fade2+= 3; 
  }  
  //Final F (seleccion= 1027)
  if(time4>=88 && seleccion4==1027){
    ...
    fill(0,fade2); rect (0,0, width, height);
    textAlign (CENTER);
    fill(255,(fade2-350)); text("Final [F]", (width/2), height/2-15-cUp);
    fill(255,(fade2-600)); text("Hisoria de una pareja [F]eliz", (width/2), height/2+15-cUp);
    fade2+= 3;
  }  
  //Final I (seleccion= 1009)
  if(time4>= 102 && seleccion4==1009){
    ...
    fill(0,fade2); rect (0,0, width, height);
    textAlign (CENTER);
    fill(255,(fade2-350)); text("Final [I]", (width/2), height/2-15-cUp);
    fill(255,(fade2-600)); text("Hisoria de un amor [I]ncierto", (width/2), height/2+15-cUp);
    fade2+= 3;
  }  
  ...
  if(time4>=48 && seleccion4==1046){
    ...
    fill(0,fade2); rect (0,0, width, height);
    textAlign (CENTER);
    fill(255,(fade2-350)); text("Final [U]", (width/2), height/2-15-cUp);
    fill(255,(fade2-600)); text("[Ú]ltima Fantasía ", (width/2), height/2+15-cUp);
    fade2+= 3;
  }  
  ...
  if(time3>=27 && seleccion3==30 || time3>=20 && seleccion3==11){
    ...
    textAlign (CENTER);
    fill(255,(fade3-350)); text("Final [M]", (width/2), height/2-15-cUp);
    fill(255,(fade3-600)); text("[M]entiras", (width/2), height/2+15-cUp);
    fade3+= 3;
  }
  ...
  if(fade2==1003){
    cUp+=1.8;
    textAlign (CENTER);
    text("Programador", (width/2)-120, (height+330-cUp)); 
    text("Diego Jimenez", (width/2)+120, (height+330-cUp));
    
    text("Guionista", (width/2)-120, (height+360-cUp)); 
    text("Diego Jimenez", (width/2)+120, (height+360-cUp));
    
    text("Lucy", (width/2)-120, (height+390-cUp)); 
    text("Isabella Marinelli", (width/2)+120, (height+390-cUp));
  }
  if(fade3==1003){
    suma++; 
    if (suma>60){
    ...
    cUp+=2.5;
    textAlign (CENTER);
    text("Progrador", (width/2)-120, (height+330-cUp)); 
    text("Paul Les Tranda", (width/2)+120, (height+330-cUp));   
    text("Guiosta", (width/2)-120, (height+360-cUp)); 
    text("CarOL GiNEbra", (width/2)+120, (height+360-cUp)); 
    text("Lucy", (width/2)-120, (height+390-cUp)); 
    text("MarIENl Sus", (width/2)+120, (height+390-cUp));  
    text("Msuica", (width/2)-120, (height+420-cUp)); 
    text("HAnZ SiMEl", (width/2)+120, (height+420-cUp));  
    text("Diseñador", (width/2)-120, (height+450-cUp)); 
    text("Duanes MICHalsl", (width/2)+120, (height+450-cUp));
  }
  if(time5>=9){
    cUp-=10;
    if(time5>=12){
